...
// New creates a new QRL consensus client service, trying different implementations at the given address.
...
func New(ctx context.Context, params ...Parameter) (consensusclient.Service, error) {
	...
	// No luck
	return nil, errors.New("failed to connect to QRL consensus client with any known method")
}
