...
// New creates a new QRL client service, trying different implementations at the given address.
...
func New(ctx context.Context, params ...Parameter) (consensusclient.Service, error) {
	...
	// No luck
	return nil, errors.New("failed to connect to QRL client with any known method")
}
