...
func (s *Service) Validators(ctx context.Context,
	...
	*api.Response[map[capella.ValidatorIndex]*apiv1.Validator],
	...
	ctx, span := otel.Tracer("attestantio.go-consensus-client.http").Start(ctx, "Validators")
	defer span.End()
...
func (s *Service) validatorsFromState(ctx context.Context,
	...
	*api.Response[map[capella.ValidatorIndex]*apiv1.Validator],
	...
	ctx, span := otel.Tracer("attestantio.go-consensus-client.http").Start(ctx, "validatorsFromState")
	defer span.End()
