...
func (f *ForkEpochs) Active(epoch capella.Epoch) []*ForkEpoch {
	activated := []*ForkEpoch{}
...
func (f *ForkEpochs) Scheduled(epoch capella.Epoch) []*ForkEpoch {
	scheduled := []*ForkEpoch{}
...
func (f *ForkEpochs) CurrentFork(epoch capella.Epoch) (*ForkEpoch, error) {
	found := false
...
func (f *ForkEpochs) PreviousFork(epoch capella.Epoch) (*ForkEpoch, error) {
	if len(*f) == 1 {
