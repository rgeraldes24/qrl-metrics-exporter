...
type Options struct {
	...
	GoConsensusClientParams []ehttp.Parameter
}
...
// AddGoConsensusClientParams adds the given parameters to the options.
func (o *Options) AddGoConsensusClientParams(params ...ehttp.Parameter) *Options {
	o.GoConsensusClientParams = append(o.GoConsensusClientParams, params...)

	return o
}

// GetGoConsensusClientParams returns the parameters for the go-consensus-client.
func (o *Options) GetGoConsensusClientParams() []ehttp.Parameter {
	return o.GoConsensusClientParams
}
